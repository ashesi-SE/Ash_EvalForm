...
<div class="container">
  <div class="row">
    ...
    <?php
    //retrieving teams and calsses created
                    $dataset=mysql_query("select * from classes",$con);
...
//while($row){
	...
	echo "<table border='2' >";
	echo "<tr bgcolor='DarkRed' ><td>Class ID</td><td>".$row["cid"]."</td></tr>";
	echo "<tr><td>Class Name</td><td>".$row["class"]."</td></tr>";
	echo "<tr><td>Teams</td><td>".$row["team"]."</td></tr>";
//}
